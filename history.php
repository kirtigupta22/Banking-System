...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="#"><img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
...
<class class="welcome">
        <h2>
            <img src="logos/t1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong>
            <img src="logos/t1.png" alt="Bank" width="75" height="75" style="font-weight: bold;">
        </h2>
    </class>
...
<tr style="color : black;">
    ...
    <!-- options -->
      ...
      <a href="money.php"><button type="button" class="btn btn-dark btn-lg mb-3">Click Here to Transfer Money</button></a>
      </div>
    </div>
</div>
