...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/m2.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
            ...
            <div class="col text-center">
                <div class="table-responsive-sm">
                    ...
                    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
                        <a href="history.php"><button type="button" class="btn btn-success btn-lg mb-3">See all Transaction History</button></a>
                    </div>
                </div>
            </div>
        </div>
